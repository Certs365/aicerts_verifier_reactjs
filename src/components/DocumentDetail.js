...
const DocumentDetail = ({ handleFileChange, apiData, isLoading }) => {
  ...
  useEffect(() => {
    if (apiData && apiData?.Details && apiData?.Details["Custom Fields"]) {
      const customFields = convertToCustomArray(
        apiData.Details["Custom Fields"]
      );
      // @ts-ignore: Implicit any for children prop
  ...
  const image =
    "https://images.netcomlearning.com/ai-certs/cer365AllPageBg.png";
                      ...
                      <Col xs={{ span: 12 }} md={{ span: 12 }}>
                        {apiData?.Details ? (
                          <>
                            <Card
                              ref={certificateRef}
                              className="valid-cerficate-info"
                            >
                                ...
                                >
                                  ...
                                  <Form className="p-4 p-md-0">
                                    <div className="d-flex justify-content-center align-items-center">
                                      <Link
                                        ...
                                        className="golden-upload valid-again"
                                      >
                                        Validate Another
                                      </Link>
                                    </div>
                                  ...
                                  <div className="d-flex justify-content-center align-items-center ">
                                    <FacebookShareButton
                                      ...
                                      className="mr-5"
                                    >
                                      <FacebookIcon size={32} round borderRadius={0}  />
                          ...
                          <>
                            ...
                            <Form>
                              ...
                              <div className="information text-center pb-md-0 pb-4">
                                Only <strong>PDF</strong> is supported. <br />{" "}
                                (Upto 2 MB)
                              </div>
                            </Form>
                          </>
