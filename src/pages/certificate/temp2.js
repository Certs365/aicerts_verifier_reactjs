...
const CertificateTemplateOne = ({ apiData }) => {
    ...
    //     if (html2pdfModule) {
    //         const element = document.getElementById('template-5');
    ...
    const handleDownload = () => {
        if (html2pdfModule) {
            ...
            clonedStyles.innerHTML = `
                ...
                .certificate-template#template-5 {
                    background-image: url(/backgrounds/certificate-template-5-bg.svg);
                    padding: 32px 0 5.625em;
                }
                .certificate-template#template-5 .badge-position {
                    bottom: 240px;
                }
                .certificate-template#template-5 .bottom-info {
                    bottom: 190px;
                }
                    ...
                    <div className='container py-5'>
                        <div className='certificate-template position-relative' id="template-5">
                            ...
                            <div className='issued-by text-center'>
                                <div className='signature' style={{paddingTop:"35%"}}>
                            ...
                            {/* <div className='badge-position position-absolute' style={{marginRight:"10%"}}>
